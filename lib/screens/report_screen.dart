      ...
      if (query.isEmpty) {
        ...
        setState(() {
          _filteredReports = _list!.where((report) {
            return report.reportsData.predictedClass.toLowerCase().contains(query.toLowerCase());
          }).toList();
        });
      }
    }
                    ...
                    if (_filteredReports!.isEmpty) {
                      ...
                      return ListTile(
                          ...
                          title: Row(
                            children: [
                              Text(
                                _filteredReports![index].reportsData.predictedClass.toString(),
                                style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.w700),
                              ),
                              Spacer(),
                              SizedBox(
                              ...
                              InkWell(
                                  onTap: () {
                                    value.deleteReportById(_filteredReports![index].id);
                                  },
                                  child: Image.asset(
                                    'assets/images/del.png',
                                    height: 24,
                          ...
                          subtitle: _filteredReports![index].time != null ? Text(formatDate(_filteredReports![index].time)) : Text("sa"));
                    }
                  },
